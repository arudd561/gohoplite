        ...
        <div id="contentDiv" class="layout-div">
            <div class="index-content-div">
                ...
                <div style="text-align: center; margin: 1em 0px 2em;">
                    ...
                    Hosting options to meet your needs.
                    </p>
                </div>
                <div style="white-space: nowrap; text-align: center;">
                    <div style="margin: 0px 1em; height: 300px; min-width: 200px; width: 30%; border: 1px solid #555555; border-radius: 3px; display: inline-block; vertical-align: top; opacity: 1; background-color: #222222;">
                        <h2>C<span class="smaller-text">LOUD</span> SaaS</h2>
                        &nbsp;
                    </div>
                    <div style="margin: 0px 1em; height: 300px; min-width: 200px; width: 30%; border: 1px solid #555555; border-radius: 3px; display: inline-block; vertical-align: top; opacity: 1; background-color: #222222;">
                        <h2>V<span class="smaller-text">IRTUAL</span> P<span class="smaller-text">RIVATE</span> S<span class="smaller-text">ERVER</span></h2>
                        &nbsp;
                    </div>
                    <div style="margin: 0px 1em; height: 300px; min-width: 200px; width: 30%; border: 1px solid #555555; border-radius: 3px; display: inline-block; vertical-align: top; opacity: 1; background-color: #222222;">
                        <h2>O<span class="smaller-text">N</span>-P<span class="smaller-text">REMISES</span></h2>
                        &nbsp;
                    </div>
                </div>
            </div>
